...
import { ArrowLeft, ArrowRight, ChevronLeft, ChevronRight, Sparkles, Paintbrush, RotateCcw, CheckCircle2, Share2, Mail, Facebook, Instagram } from 'lucide-react';
          ...
          {rendered && (
            ...
            >
              <Button
                ...
                className="w-full h-12 text-base font-semibold rounded-xl bg-[#c8540a] hover:bg-[#e06820] text-white transition-all flex items-center justify-center gap-3"
              >
                <span className="flex items-center gap-2">
                  <Share2 className="w-4 h-4" /> Share This Transformation
                </span>
